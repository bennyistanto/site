---
title: "Into early 2027, and how little forty-four events support"
...
image: "../assets/image-blog/20260911-into-early-2027-01.png"
categories:
  - "Climate"
  - "Data Science"
  - "Research"
...
Nine posts of claims. What holds them up is thinner than seventy-six years of record makes it sound.
...
![](../assets/image-blog/20260911-into-early-2027-01.png)
...
![](../assets/image-blog/20260911-into-early-2027-02.png)
...
![](../assets/image-blog/20260911-into-early-2027-03.png)
...
On 56 to 74 per cent of land, depending on the season, the fitted relationship predicts worse than simply guessing that season's own average. A negative cross-validated R² is neither a bug nor a marginal case here. That is the ordinary condition of a weak teleconnection, and it covers most of the world.
...
About the Maritime Continent, quite a lot. Rainfall at 61 per cent of normal in the analogue seasons, nearly every analogue agreeing, cross-validated skill over 79 per cent of the region's land in SON, a third of it elevated for four or more consecutive seasons, and an observed August 2026 already at the 92nd percentile with half the region's land in a dry spell. That reads like five independent lines, and it is not. The first two come from the same five analogue seasons, and the sign agreement is a measure of how tightly those seasons cluster rather than a separate test of them. The third and fourth both rest on the same season-specific regression. Only the observed August is independent of the rest. Call it three lines, one of which does not lean on the historical fit at all, and they land in the same place.
...
*This is the tenth and final post in the series. The reading order is on the [El Niño 2026](../blog-series-el-nino.qmd) page. The analysis code is in the project repository, and every figure is produced by a script that recomputes its numbers from the source data instead of quoting them.*
