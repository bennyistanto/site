...
![The full model in ArcGIS: data layers in yellow, tools in orange, temporary outputs in green and final outputs in blue](../assets/image-blog/20141216-osm-use-case-market-accessibility-13.jpg)
...
![The accessibility model end to end, from elevation, roads, rivers, land use and points of interest through to the share of population within three hours](../assets/image-blog/20141216-osm-use-case-market-accessibility-12.jpg)
...
![Travel speed assigned to each OSM highway class, in km/h and m/min](../assets/image-blog/20141216-osm-use-case-market-accessibility-01.jpg)
...
![Walking speed assigned to each Globcover land cover class, in m/min](../assets/image-blog/20141216-osm-use-case-market-accessibility-02.jpg)
...
![Environment Settings, snapping new rasters to the SRTM elevation layer and matching its extent](../assets/image-blog/20141216-osm-use-case-market-accessibility-03.jpg)
...
![Features to Raster, converting the road layer with AvgSpeed as the pixel value](../assets/image-blog/20141216-osm-use-case-market-accessibility-04.jpg)
...
![Mosaic to New Raster, combining border, road, river and land speeds in that order with the FIRST operator](../assets/image-blog/20141216-osm-use-case-market-accessibility-05.jpg)
...
![The Slope tool, output in percent with a Z factor of 0.00000912 for Sumba](../assets/image-blog/20141216-osm-use-case-market-accessibility-06.jpg)
...
![Reclassifying slope into weights that penalise travel speed](../assets/image-blog/20141216-osm-use-case-market-accessibility-07.jpg)
...
![Travel time classes in minutes and their equivalent in hours and days](../assets/image-blog/20141216-osm-use-case-market-accessibility-08.jpg)

![Travel time to the nearest market across Sumba, from under 15 minutes to more than 12 hours](../assets/image-blog/20141216-osm-use-case-market-accessibility-09.jpg)
...
![The four inputs to the example: sub-district boundary, population, travel time and market catchment](../assets/image-blog/20141216-osm-use-case-market-accessibility-10.jpg)
...
![Population by sub-district, classed from under 2,500 to over 35,000](../assets/image-blog/20141216-osm-use-case-market-accessibility-11.jpg)