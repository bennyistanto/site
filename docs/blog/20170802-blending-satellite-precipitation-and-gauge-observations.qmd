...
date: "2017-08-02"
description: "How to blend rain gauge observations with satellite precipitation estimates, using a regression model and kriging of the residuals, step by step"
...
![The 152 BMKG stations plotted over the satellite precipitation grid](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-03.jpg)

Regression model Rainfall - SPE

![Station rainfall against CHIRP for dekad 1 of January 2017, giving y = 1.0872x - 4.3614 with R² = 0.3551](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-02.jpg)

Modelled rainfall grid and residuals

![Kriged residuals: red where the estimate is too high, blue where it is too low](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-04.jpg)

Add back to the initial estimate

![The satellite grid plus the kriged residuals, giving the blended result](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-05.jpg)
...
![CHIRPS and CHIRP for June 2017 side by side, the difference being the station data CHIRPS includes](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-01.jpg)
...
![The BMKG workbook, with daily rain gauge data on the Station and Data Original worksheets](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-06.jpg)
...
![ArcToolbox, Conversion Tools, Excel to Table](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-07.jpg)
...
![Display XY Data, with longitude as X, latitude as Y and the coordinate system set to GCS_WGS_1984](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-08.jpg)
...
![Exporting the table events to a shapefile](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-09.jpg)
...
![The scatter chart built in the spreadsheet, with the linear trendline and its equation shown](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-10.jpg)
...
![Residuals in mm across the 152 stations](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-17.jpg)

#### Kriging of residuals

Copy the data to new workbook, and save as new spreadsheet.

![The residual values copied into a fresh workbook, ready to bring back into ArcGIS](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-11.jpg)
...
![The Kriging tool, ordinary method on a spherical semivariogram, with RESIDUAL as the Z value](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-12.jpg)
...
![Extract by Mask, clipping the interpolated surface to the Indonesia boundary](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-13.jpg)
...
![Adding the residual surface to the CHIRP grid in Raster Calculator](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-14.jpg)

Final Result

![The blended rainfall grid for dekad 1, January 2017, from 152 stations](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-15.jpg)
...
![The same dekad blended from more than 1000 stations, showing much finer detail](../assets/image-blog/20170802-blending-satellite-precipitation-and-gauge-observations-16.jpg)