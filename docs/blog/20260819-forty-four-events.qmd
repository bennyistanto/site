---
title: "Forty-four ENSO events, and only eight that can answer anything"
...
One provenance note before the numbers, because this claim carries a lot of weight later. The events themselves are identified on RONI, which is built from ERSST v6. The eastern-against-central classification comes from the Niño-region indices, and this project's copy of those is **ERSST v5**. The two are close but not the same product, so the flavour label is v5 evidence attached to a v6 event list.
...
Length is counted in overlapping three-month seasons, the ASO, SON, OND units from the first post. Because each one shares two months with the next, eight seasons covers about ten calendar months, well short of the twenty-four that multiplying would give.
...
Each of the eight strong events aligned on its own peak season, with the 2026 outlook aligned the same way, ignoring calendar date.
...
And any claim about a strong El Niño rests on eight events. The last post comes back to this and puts a number on how much information eight events, and 912 months, actually carry. Less, in both cases, than the figure sounds.

*Next: [Drought has two halves, and most maps measure one](20260822-two-ways-to-see-a-drought.qmd), on which two indices this series uses and which it deliberately leaves out.*
