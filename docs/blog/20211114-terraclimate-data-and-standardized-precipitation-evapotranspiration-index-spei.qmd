...
process_climate_indices --index spei --periodicity monthly \
  --netcdf_precip <in_dir>/wld_cli_terraclimate_ppt_1958_2020.nc --var_name_precip ppt \
  --netcdf_pet <in_dir>/wld_cli_terraclimate_pet_1958_2020.nc --var_name_pet pet \
  --output_file_base <out_dir>/wld_cli \
  --scales 1 2 3 6 9 12 18 24 36 48 60 72 \
  --calibration_start_year 1958 --calibration_end_year 2020 \
  --multiprocessing all
```
