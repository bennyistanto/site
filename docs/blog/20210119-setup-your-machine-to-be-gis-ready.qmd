...
date: "2021-01-19"
description: "How I install and configure a whole geospatial software stack on a new machine, after years of untangling geo tools and their dependencies"
...
I just type below code in Terminal, then everything will install automatically. But if you missed some formula, you can easily install it.
  ...
  ```bash
  brew install libgeotiff netcdf
  ```
