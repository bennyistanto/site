...
date: "2024-01-24"
description: "Last month I did experiment test to analyze the propagation of Meteorological Drought (Standardized Precipitation Index - SPI) to Hydrological Drought (Standardized Streamflow Index - SSI) using La..."
image: "../assets/image-blog/20240124-drought-propagation-01.png"
categories:
  - "Remote Sensing"
  - "Research"
  - "Climate"
...
1. [`1_Steps_to_Generate_SPI_Using_CHIRPS_Data.ipynb`](https://github.com/bennyistanto/drought-propagation/blob/main/1_Steps_to_Generate_SPI_Using_CHIRPS_Data.ipynb)
2. [`2_Steps_to_Generate_SSI_Using_GloFAS-ERA5_Data.ipynb`](https://github.com/bennyistanto/drought-propagation/blob/main/2_Steps_to_Generate_SSI_Using_GloFAS-ERA5_Data.ipynb)
3. [`3_Drought_Propagation_Met2Hyd_Using_CCA.ipynb`](https://github.com/bennyistanto/drought-propagation/blob/main/3_Drought_Propagation_Met2Hyd_Using_CCA.ipynb)
...
![Drought](../assets/image-blog/20240124-drought-propagation-01.png)
...
1. SPI 03 and SSI 03, Lag 1-month
   ...
   ![SM1](https://raw.githubusercontent.com/bennyistanto/drought-propagation/main/prop/images/cor_spi03_ssi03_lag01.png)

2. SPI 06 and SSI 03, Lag 1-month

   ![SM2](https://raw.githubusercontent.com/bennyistanto/drought-propagation/main/prop/images/cor_spi06_ssi03_lag01.png)

3. SPI 06 and SSI 03, Lag 3-month

   ![SM3](https://raw.githubusercontent.com/bennyistanto/drought-propagation/main/prop/images/cor_spi06_ssi03_lag03.png)

4. SPI 12 and SSI 06, Lag 6-month

   ![SM4](https://raw.githubusercontent.com/bennyistanto/drought-propagation/main/prop/images/cor_spi12_ssi06_lag06.png)
...
1. Most frequent correlation and Lag where the most frequent observe of SPI to SSI 3-month
   ...
   ![SM1](https://raw.githubusercontent.com/bennyistanto/drought-propagation/main/prop/images/idn_cli_freq_corr_combination_1.png)

2. Most frequent correlation and Lag where the most frequent observe of SPI to SSI 6-month

   ![SM2](https://raw.githubusercontent.com/bennyistanto/drought-propagation/main/prop/images/idn_cli_freq_corr_combination_2.png)

3. Most frequent correlation and Lag where the most frequent observe of SPI to SSI 9-month

   ![SM3](https://raw.githubusercontent.com/bennyistanto/drought-propagation/main/prop/images/idn_cli_freq_corr_combination_3.png)

4. Most frequent correlation and Lag where the most frequent observe of SPI to SSI 12-month

   ![SM4](https://raw.githubusercontent.com/bennyistanto/drought-propagation/main/prop/images/idn_cli_freq_corr_combination_4.png)

5. Maximum correlation and Lag where the maximum observe of SPI to SSI 3-month

   ![SM1](https://raw.githubusercontent.com/bennyistanto/drought-propagation/main/prop/images/idn_cli_max_corr_combination_1.png)

6. Maximum correlation and Lag where the maximum observe of SPI to SSI 6-month

   ![SM2](https://raw.githubusercontent.com/bennyistanto/drought-propagation/main/prop/images/idn_cli_max_corr_combination_2.png)

7. Maximum correlation and Lag where the maximum observe of SPI to SSI 9-month

   ![SM3](https://raw.githubusercontent.com/bennyistanto/drought-propagation/main/prop/images/idn_cli_max_corr_combination_3.png)
   
8. Maximum correlation and Lag where the maximum observe of SPI to SSI 12-month

   ![SM4](https://raw.githubusercontent.com/bennyistanto/drought-propagation/main/prop/images/idn_cli_max_corr_combination_4.png)
