...
date: "2024-01-24"
description: "Tracing how meteorological drought (SPI) propagates into hydrological drought (SSI) across Indonesia, using lagged correlation at the pixel level"
...
* $Y_{i+\tau}$: Value of the second time series at time $i + \tau$
* $\tau$: Time lag
* $\bar{X}$: Mean of the first time series
* $\bar{Y}$: Mean of the second time series
...
1. SPI 03 and SSI 03, Lag 1-month
   ...
   ![SM1](../assets/image-blog/20240124-drought-propagation-01-01.png)

2. SPI 06 and SSI 03, Lag 1-month

   ![SM2](../assets/image-blog/20240124-drought-propagation-01-02.png)

3. SPI 06 and SSI 03, Lag 3-month

   ![SM3](../assets/image-blog/20240124-drought-propagation-01-03.png)

4. SPI 12 and SSI 06, Lag 6-month

   ![SM4](../assets/image-blog/20240124-drought-propagation-01-04.png)
