...
The correction is the **Bretherton effective sample size**, which uses the lag-1 autocorrelation of *both* series, $r_1$ for the predictor and $r_2$ for the response:
