...
![Figure 1 . Distance from a location](../assets/image-blog/20190422-surface-buffer-01.jpg)
...
![Figure 2. 12 km from the peak of Gunung Agung, Bali - Indonesia](../assets/image-blog/20190422-surface-buffer-02.jpg)
...
::: {.callout-note collapse="true" title="Python - Surface buffer"}
```python
import arcpy 
import os 
import math 
