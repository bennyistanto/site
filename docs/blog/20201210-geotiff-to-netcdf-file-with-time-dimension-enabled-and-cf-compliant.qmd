...
date: "2020-12-10"
description: "A notebook that turns a folder of GeoTIFF rasters into a single netCDF with the time dimension enabled and CF-compliant attributes"
...
* I have try to manually convert GeoTIFF file to netCDF using GDAL: *gdal\_translate -of netCDF input.tif output.nc*, it’s worked. But the time dimension is not enabled. While SPI script will read the netCDF input file based on time dimension. It means SPI script will not work with this solution.
