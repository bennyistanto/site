...
Google Earth Engine is not involved; this runs in Colab, where TensorFlow is already present and the GPU is provisioned. The repository ships an 11 MB Bali example that runs end to end in about fifteen minutes on a free Colab CPU, through a seven-notebook pipeline from AOI definition to visualisation.
