...
subtitle: "Standardized Precipitation Evapotranspiration Index, 1950 to 2025"
page-layout: full
toc: false
...
Two things about the first year. TerraClimate cautions that 1950 may be affected by water balance model spin-up, but that concerns the model's storage outputs, such as soil moisture and runoff. Precipitation is an input, and potential evapotranspiration is computed from the climate variables rather than carried forward by the water balance. A trial evaporative-demand run bears this out: within its v1.1 years, 1950 sat inside the range of 1951 to 1957 on both mean and spread. Separately, an accumulation needs its full window before it can produce a value, so each timescale starts late by its own length, and the 12-month index has its first value in December 1950.
...
|---|---|---|
| 1 month | `wld_cli_terraclimate_spei_pearson3_1_month.nc` | In preparation |
| 2 month | `wld_cli_terraclimate_spei_pearson3_2_month.nc` | In preparation |
| 3 month | `wld_cli_terraclimate_spei_pearson3_3_month.nc` | In preparation |
| 6 month | `wld_cli_terraclimate_spei_pearson3_6_month.nc` | In preparation |
| 9 month | `wld_cli_terraclimate_spei_pearson3_9_month.nc` | In preparation |
| 12 month | `wld_cli_terraclimate_spei_pearson3_12_month.nc` | In preparation |
| 18 month | `wld_cli_terraclimate_spei_pearson3_18_month.nc` | In preparation |
| 24 month | `wld_cli_terraclimate_spei_pearson3_24_month.nc` | [26.98 GB](https://drive.google.com/file/d/12NA-iyctgTsaGylziyCsFOtuOJwyWkOU/view?usp=drive_link) |
| 36 month | `wld_cli_terraclimate_spei_pearson3_36_month.nc` | In preparation |
| 48 month | `wld_cli_terraclimate_spei_pearson3_48_month.nc` | [25.69 GB](https://drive.google.com/file/d/1PvKnn1LQUNZDlFtQJ730mMngsJCKY_eh/view?usp=drive_link) |
| 60 month | `wld_cli_terraclimate_spei_pearson3_60_month.nc` | In preparation |
| 72 month | `wld_cli_terraclimate_spei_pearson3_72_month.nc` | In preparation |
